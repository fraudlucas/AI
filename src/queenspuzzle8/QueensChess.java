package queenspuzzle8;

/**
 * 
 * Heuristic is how many attacks are possible to be done.
 * The queens can be moved only in their own column.
 * 
 * @author Marcus Lucas Abreu de Araujo Falcão.
 *
 */

public class QueensChess implements Comparable<QueensChess>{
	...
	@Override
	public int compareTo(QueensChess toCompare) {
		// TODO Auto-generated method stub
		return queensUnderAttack - toCompare.getQueensUnderAttack();
	}
	...
	/**
	 * Column index of the chess array. 
	 * @return int
	 */
